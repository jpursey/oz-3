...
const MicrocodeDef kMicroCodeDefs[] = {
    ...
    {kMicro_CMPI, "CMPI", MicroArgType::kWordReg, MicroArgType::kValue},
    {kMicro_CMP, "CMP", MicroArgType::kWordReg, MicroArgType::kWordReg},
    {kMicro_MSKI, "MSKI", MicroArgType::kWordReg, MicroArgType::kValue},
    {kMicro_MSK, "MSK", MicroArgType::kWordReg, MicroArgType::kWordReg},
